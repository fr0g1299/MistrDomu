        ...
        try {
            ...
            if (response.ok) {
                ...
                if (errData.errors) {
                    ...
                    setErrors(errData.map((err: any) => err.description));
                } else {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative">
                ...
                <Input name="password" type="password" placeholder="Heslo" className="pl-10" required />
            </div>

            <div className="relative">
                <Lock className="absolute left-3 top-3 h-4 w-4 text-muted-foreground" />
                <Input name="confirmPassword" type="password" placeholder="Potvrzení hesla" className="pl-10" required />
            </div>
